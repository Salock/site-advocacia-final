document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ...
        'imobiliario_meta_description': { pt: 'Segurança jurídica para seu imóvel em todas as etapas.', en: 'Legal security for your property at every stage.', es: 'Seguridad jurídica para su inmueble en todas as etapas.', fr: 'Sécurité juridique pour votre bien immobilier à chaque étape.' },
        ...
        'pilar1_text': { 
            ...
            es: 'VMatos Assessoria Jurídica fue fundado com a missão de actuar en el mercado inmobiliario, centrándose en la rescisión de contratos de compraventa de inmuebles sobre plano. La génesis de nuestra actuación reside en la constatación de las innumerables vulnerabilidades y disgustos que enfrentan los adquirentes de inmuebles, quienes frecuentemente se encuentran com falta de transparencia, retrasos en la entrega y onerosidade excesiva por parte de las constructoras y promotoras.', 
            fr: 'VMatos Assessoria Jurídica a été fondé avec la mission d\'opérer sur le marché immobilier, en se concentrant sur la résiliation des contrats d\'achat et de vente de biens immobiliers sur plan. La genèse de notre travail réside dans l\'observation des nombreuses vulnérabilités e désagréments rencontrés par les acheteurs de biens immobiliers, qui sont souvent confrontés à un manque de transparence, des retards de livraison et des coûts excessifs de la part des constructeurs et promoteurs.' 
        },
        ...
        'pilar2_text': { 
            ...
            fr: 'Avec une vision stratégique et humanisée, nous avons identifié le besoin d\'un soutien juridique pouvant sauvegarder les droits des consommateurs. Nous offrons des solutions juridiques efficaces pour la résolution des conflits, garantindo le remboursement des montants payés, l\'annulation des clauses et amendes abusives et une juste réparation pour les préjudices moraux.' 
        },
        ...
        'pilar3_text': { 
            ...
            fr: 'Notre équipe est composée de professionnels possédant une vaste connaissance en droit immobilier et de la consommation. Nous nous consacrons entièrement à chaque caso, en recherchant la meilleure stratégie pour garantir que les droits de nos clients soient intégralement préservés.' 
        },
