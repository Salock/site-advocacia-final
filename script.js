document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ...
        'migratorio_pilar1_title': { pt: 'Acolhimento Humanizado', en: 'Humanized Welcome', es: 'Acogida Humanizada', fr: 'Accueil Humanisé' },
        'migratorio_pilar1_text': { pt: 'Entendemos que a mudança para um novo país é um grande passo. Por isso, nossa missão é tornar sua chegada ao Brasil o mais fácil e acolhedora possível, cuidando de você em cada detalhe desde o primeiro momento.', en: 'We understand that moving to a new country is a big step. Therefore, our mission is to make your arrival in Brazil as easy and welcoming as possible, taking care of you in every detail from the very first moment.', es: 'Entendemos que mudarse a un nuevo país es un gran paso. Por eso, nuestra misión es hacer su llegada a Brasil lo más fácil y acogedora posible, cuidando de usted en cada detalle desde el primer momento.', fr: 'Nous comprenons que déménager dans un nouveau pays est une grande étape. C\'est pourquoi notre mission est de rendre votre arrivée au Brésil aussi simple et accueillante que possible, en prenant soin de vous dans les moindres détails dès le premier instant.' },
        'migratorio_pilar2_title': { pt: 'Solução Completa e Integrada', en: 'Complete and Integrated Solution', es: 'Solución Completa e Integrada', fr: 'Solution Complète et Intégrée' },
        'migratorio_pilar2_text': { pt: 'Oferecemos uma assessoria que vai além da obtenção do visto. Cuidamos da sua recepção no aeroporto com transfer privativo, garantindo que você e suas malas cheguem ao seu destino com total segurança e conforto.', en: 'We offer advisory that goes beyond obtaining a visa. We take care of your airport reception with a private transfer, ensuring that you and your luggage arrive at your destination with total safety and comfort.', es: 'Ofrecemos una asesoría que va más allá de la obtención del visado. Nos encargamos de su recepción en el aeropuerto con traslado privado, garantizando que usted y sus maletas lleguen a su destino con total seguridad y comodidad.', fr: 'Nous offrons un conseil qui va au-delà de l\'obtention du visa. Nous nous occupons de votre accueil à l\'aéroport avec un transfert privé, garantissant que vous et vos bagages arriviez à destination en toute sécurité et confort.' },
        'migratorio_pilar3_title': { pt: 'Foco no seu Novo Começo', en: 'Focus on Your New Beginning', es: 'Enfoque en su Nuevo Comienzo', fr: 'Concentrez-vous sur Votre Nouveau Départ' },
        'migratorio_pilar3_text': { pt: 'Nós pensamos em toda a logística para que você não precise se preocupar. Nosso objetivo é garantir sua tranquilidade, permitindo que você se concentre no que realmente importa: o início da sua nova vida no Brasil.', en: 'We think about all the logistics so you don\'t have to worry. Our goal is to ensure your peace of mind, allowing you to focus on what really matters: the beginning of your new life in Brazil.', es: 'Pensamos en toda la logística para que no tenga que preocuparse. Nuestro objetivo es garantizar su tranquilidad, permitiéndole concentrarse en lo que realmente importa: el comienzo de su nueva vida en Brasil.', fr: 'Nous pensons à toute la logistique pour que vous n\'ayez pas à vous inquiéter. Notre objectif est de garantir votre tranquillité d\'esprit, vous permettant de vous concentrer sur ce qui compte vraiment : le début de votre nouvelle vie au Brésil.' },
